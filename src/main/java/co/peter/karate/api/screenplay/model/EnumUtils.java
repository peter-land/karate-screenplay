...
import static co.peter.karate.api.model.data.Variables.REQUEST_BODY_KEY;
import static co.peter.karate.api.screenplay.tasks.KarateVars.update;
import static co.peter.karate.api.screenplay.tasks.BaseScript.MERGE_JSON;
...
public class EnumUtils {
    ...
    public static void setRequestBodyVariable(String filePathBaseObject, String complementaryObject){
        ...
        update("jsonStrA", body);
        update("jsonStrB", complementaryObject);
        Map<String, Object> result = KarateRunner.performAsAnonymous(MERGE_JSON);
        update(REQUEST_BODY_KEY, result.get("jsonMix"));
    }
}
